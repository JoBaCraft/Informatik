...
while AnzahlSchiffe > VorhandeneSchiffe:
    ...
    if feld[SchiffZeile][SchiffSpalte] != "S":
        ...
        VorhandeneSchiffe += 1
    if feld[SchiffZeile][SchiffSpalte] != "S":
        if feld[SchiffZeile-1][SchiffSpalte] != "S" or feld[SchiffZeile-1][SchiffSpalte] >= 7:
           if feld[SchiffZeile-1][SchiffSpalte-1] != "S" or feld[SchiffZeile-1][SchiffSpalte-1] >= 7:
                if feld[SchiffZeile][SchiffSpalte-1] != "S" or feld[SchiffZeile][SchiffSpalte-1] >= 7:
                    if feld[SchiffZeile+1][SchiffSpalte-1] != "S" or feld[SchiffZeile+1][SchiffSpalte-1] >= 7:
                        if feld[SchiffZeile+1][SchiffSpalte] != "S" or feld[SchiffZeile+1][SchiffSpalte] >= 7:
                            if feld[SchiffZeile+1][SchiffSpalte+1] != "S" or feld[SchiffZeile+1][SchiffSpalte+1] >= 7:
                                if feld[SchiffZeile][SchiffSpalte+1] != "S" or feld[SchiffZeile][SchiffSpalte+1] >= 7:
